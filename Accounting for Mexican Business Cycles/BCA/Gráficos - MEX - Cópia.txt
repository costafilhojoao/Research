...
saveas(gcf, 'H:\Google Drive\Documents\FEP\Thesis\2. México\figure1', 'jpg')
...
saveas(gcf, 'H:\Google Drive\Documents\FEP\Thesis\2. México\figure2', 'jpg')
...
saveas(gcf, 'H:\Google Drive\Documents\FEP\Thesis\2. México\figure3', 'jpg')
...
XLABEL('Investment')
SUBPLOT(2,2,4)
plot(t, worktemp.hpw(1:l,4),'DisplayName','worktemp.hpw(1:l,4)','YDataSource','worktemp.hpw(1:l,4)');figure(gcf)
axis([min(t) max(t) -0.3 0.3])
