...
close all;
de = xlsread('data','Sheet1',['C','2',':','C','109']);   
dy = xlsread('data','Sheet1',['D','2',':','D','109']);   
M_.params(1) = 0.98;
beta = M_.params(1);
M_.params(2) = 2;
gamma = M_.params(2);
...
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',1:108,'value',de) ];
M_.exo_det_length = 0;
steady;
options_.periods = 108;
...
ylabel('%')
legend('Model','Data', 'Location', 'SouthEast')
saveas(gcf, 'G:\Meu Drive\Documents\Papers\Acadêmicos\Working Papers\Accounting for Mexican Business Cycles\Submissions\2021 1 Macroeconomic Dynamics\2. R & R\1st Roundfigure19', 'jpg');
hold off;
save('mex_GHH_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('mex_GHH_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('mex_GHH_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('mex_GHH_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('mex_GHH_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('mex_GHH_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('mex_GHH_results.mat', 'oo_recursive_', '-append');
end
