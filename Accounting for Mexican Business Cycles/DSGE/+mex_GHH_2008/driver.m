...
close all;
de = xlsread('data','Sheet1',['C','54',':','C','86']);   
dy = xlsread('data','Sheet1',['D','54',':','D','86']);   
M_.params(1) = 0.98;
beta = M_.params(1);
M_.params(2) = 2;
gamma = M_.params(2);
...
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',1:33,'value',de) ];
M_.exo_det_length = 0;
steady;
...
t = [2007:0.25:2015]'; 
plot(t,oo_.endo_simul(1,1:33)*100,'k--','Linewidth',3); hold on;
...
hold off;
save('mex_GHH_2008_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('mex_GHH_2008_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('mex_GHH_2008_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('mex_GHH_2008_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('mex_GHH_2008_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('mex_GHH_2008_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('mex_GHH_2008_results.mat', 'oo_recursive_', '-append');
end
