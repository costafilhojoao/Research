...
%--------------------------------------------------------------------------------------------------------------------------------------
% 0. Dat for the simulations
%--------------------------------------------------------------------------------------------------------------------------------------

de = xlsread('data','Sheet1',['C','2',':','C','109']);   % real exchange rate shocks
dy = xlsread('data','Sheet1',['D','2',':','D','109']);   % log-linear filtered per capita output cycle
