...
gs = M_.params(11);
mubar = 1.4;
M_.params(1) = M_.params(5)/(M_.params(4)*(mubar/(1-M_.params(3)))^((1-M_.params(3))/(1+M_.params(3)))*hbar^((1-M_.params(3))/(1+M_.params(3))));
psi = M_.params(1);
M_.params(1) = 3.243573256;
psi = M_.params(1);
M_.params(12) = 100;
kappa = M_.params(12);
%
...
oo_.steady_state(17) = 0.2055346416;
oo_.steady_state(13) = oo_.steady_state(17);
oo_.steady_state(12) = 0.1512401694;
oo_.steady_state(10) = 1;
oo_.steady_state(3) = oo_.steady_state(10);
oo_.steady_state(11) = 0.7686025408;
oo_.steady_state(16) = oo_.steady_state(3)/oo_.steady_state(11);
oo_.steady_state(9) = oo_.steady_state(17)*M_.params(11);
oo_.steady_state(8) = oo_.steady_state(3)*oo_.steady_state(9);
oo_.steady_state(1) = oo_.steady_state(17)*(1-M_.params(11))-oo_.steady_state(18);
oo_.steady_state(15) = 0.5764583341;
oo_.steady_state(2) = (M_.params(5)/(M_.params(4)*M_.params(1)*oo_.steady_state(15)))^(1/(1-M_.params(3)));
oo_.steady_state(2) = 0.2129;
oo_.steady_state(5) = 0.4946749582;
oo_.steady_state(7) = oo_.steady_state(17)*oo_.steady_state(3)-oo_.steady_state(5)*oo_.steady_state(2);
oo_.steady_state(4) = (oo_.steady_state(1)-oo_.steady_state(2)^M_.params(7)/M_.params(7))^(-M_.params(6))/oo_.steady_state(3);
if M_.exo_nbr > 0
