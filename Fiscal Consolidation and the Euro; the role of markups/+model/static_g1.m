...
g1(1,4)=(-y(3));
g1(2,1)=T(5)*T(13);
g1(2,2)=T(5)*T(14)+T(4)*getPowerDeriv(y(2),params(7)-1,1);
g1(2,4)=(-y(5));
g1(2,5)=(-y(4));
g1(3,4)=1.1*(exp((-y(6)))-1);
g1(3,6)=y(4)*1.1*(-exp((-y(6))));
g1(4,1)=y(3);
g1(4,2)=(-y(5));
g1(4,3)=y(1);
g1(4,5)=(-y(2));
...
g1(15,10)=(-T(9));
g1(15,14)=(-(y(10)*T(15)));
g1(16,2)=(-(T(11)*getPowerDeriv(y(2),1-params(3),1)));
g1(16,14)=(-(T(12)*y(15)*params(1)*getPowerDeriv(y(14)*params(1),1/(params(2)-1),1)));
g1(16,15)=(-(T(10)*T(12)));
g1(16,17)=1;
g1(17,1)=(-1);
g1(17,9)=(-1);
