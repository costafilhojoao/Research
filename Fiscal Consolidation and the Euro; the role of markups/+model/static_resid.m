...
residual(5) = lhs - rhs;
lhs = log(y(9));
rhs = (1-params(10))*log(T(2))+log(y(9))*params(10)+x(2);
residual(6) = lhs - rhs;
lhs = y(18);
rhs = x(3);
residual(7) = lhs - rhs;
lhs = y(19);
rhs = params(8)+params(12)*(exp((-y(6)))-1);
residual(8) = lhs - rhs;
residual(9) = (params(2)-1)/params(2)*y(10)-y(11)+params(4)*y(12);
lhs = T(7)*y(10)*y(13)/y(14)-y(12)*(1-params(5));
rhs = (1+params(8))*y(12);
residual(10) = lhs - rhs;
lhs = y(11);
rhs = y(5)/T(8)*T(9);
...
residual(13) = lhs - rhs;
lhs = log(y(15));
rhs = (1-params(9))*log(T(3))+log(y(15))*params(9)+x(1);
residual(14) = lhs - rhs;
lhs = y(3);
rhs = y(10)*T(10);
residual(15) = lhs - rhs;
