...
close all;
dgov   = xlsread('data','Sheet1',['B','2',':','B','100']);   
M_.params(2) = 2.9;
sigma = M_.params(2);
...
oo_.steady_state(12) = 0.151063446934592;
oo_.steady_state(10) = 1;
oo_.steady_state(3) = oo_.steady_state(10);
oo_.steady_state(11) = 0.768469998994047;
oo_.steady_state(16) = 1.30128697451954;
oo_.steady_state(9) = 0.0700991824330554;
oo_.steady_state(8) = oo_.steady_state(9)*oo_.steady_state(3);
oo_.steady_state(1) = 0.135470267517254;
oo_.steady_state(15) = 0.576556784777983;
oo_.steady_state(2) = 0.2129;
oo_.steady_state(5) = 0.494674475699557;
oo_.steady_state(7) = 0.100253479952630;
oo_.steady_state(4) = 251.248982342607;
if M_.exo_nbr > 0
...
struct('exo_det',0,'exo_id',2,'multiplicative',0,'periods',1:99,'value',dgov) ];
M_.exo_det_length = 0;
steady;
options_.periods = 99;
...
var_list_ = {'mu'};
rplot(var_list_);
save('model4_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('model4_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('model4_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('model4_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('model4_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('model4_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('model4_results.mat', 'oo_recursive_', '-append');
end
