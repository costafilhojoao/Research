...
T(14) = exp((steady_state(6))/((steady_state(4))*(steady_state(8)))-y(18)/(y(16)*y(20)));
T(15) = params(16)/2*(y(22)/y(2)-1)^2;
T(16) = params(16)/params(2);
T(17) = (y(22)/y(2)-1)*T(16);
T(18) = y(44)*T(16)*(y(44)/y(22)-1)/y(22);
T(19) = T(18)*y(46);
T(20) = T(19)*y(45);
T(21) = (1-params(3))*y(35)^(1/(1-params(3)));
T(22) = y(19)^(params(3)/(1-params(3)));
T(23) = (y(3)*params(1))^((-1)/(params(2)-1));
T(24) = (y(3)*params(1))^(1/(params(2)-1));
T(25) = y(35)*T(24);
T(26) = y(14)^(1-params(3));
