...
T(12) = (1-params(14))*y(17)^(1-params(15))+params(14)*y(18)^(1-params(15));
T(13) = T(4)*y(19)^T(5)+T(6)*y(20)^T(5);
T(14) = exp((y(6))/((y(4))*(y(8)))-y(6)/(y(4)*y(8)));
T(15) = params(16)/params(2)*(y(32)/y(10)-1);
T(16) = y(32)*T(15);
T(17) = (1-params(3))*y(23)^(1/(1-params(3)));
T(18) = y(7)^(params(3)/(1-params(3)));
T(19) = (y(14)*params(1))^((-1)/(params(2)-1));
T(20) = (y(14)*params(1))^(1/(params(2)-1));
T(21) = y(23)*T(20);
T(22) = y(2)^(1-params(3));
