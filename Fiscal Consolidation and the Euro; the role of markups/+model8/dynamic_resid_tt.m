...
T(14) = params(16)/2*(y(23)/y(2)-1)^2;
T(15) = params(16)/params(2);
T(16) = (y(23)/y(2)-1)*T(15);
T(17) = y(45)*T(15)*(y(45)/y(23)-1)/y(23);
T(18) = T(17)*y(47);
T(19) = T(18)*y(46);
T(20) = (1-params(3))*y(36)^(1/(1-params(3)));
T(21) = y(20)^(params(3)/(1-params(3)));
T(22) = (y(3)*params(1))^((-1)/(params(2)-1));
T(23) = (y(3)*params(1))^(1/(params(2)-1));
T(24) = y(36)*T(23);
T(25) = y(15)^(1-params(3));
