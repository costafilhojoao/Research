...
%
% A = myols (y, x), onde y é um vetor, x é uma matriz, realiza estimativas
% de ols da regressão de y nas colunas de x.
% A é uma matriz 2 x (k + 1), onde k é o número de colunas de x, tendo o 
% parâmetro estimado na primeira linha e os erros padrão na segunda.
% Na última coluna, o primeiro elemento é a variação estimada de 
% resíduos e o segundo é o R ^ 2 corrigido.
% [A, u] = ols (y, x) produz o vetor u dos resíduos como uma saída adicional.
