sobs  = '1'; midsep = ':'; eobs ='147';
GF = xlsread('Series_matlab_145','Plan1',['A',sobs,midsep,'EO',eobs]);
sobs  = '1'; midsep = ':'; eobs ='1';
codeGF = xlsread('CodeGF_145','Plan1',['A',sobs,midsep,'EO',eobs]);
sobs  = '1'; midsep = ':'; eobs ='1';
transGF = xlsread('TransGF_145','Plan1',['A',sobs,midsep,'EO',eobs]);
x = standardize(GF);
...
figure(2);
DoSubPlots(irf,5,3,[1 2 9 10 22 23 24 33 34 44 45 46 47 48 57 ],3,titoli);

figure(3);
DoSubPlots(irf,5,3,[ 66 67 70 71 79 83 89 97 95 99 100 112 113 39 40],3,titoli);

figure(4);
DoSubPlots(irf,4,3,[ 41 42 43 116 117 118 119 138 139 141 144 145],3,titoli);
